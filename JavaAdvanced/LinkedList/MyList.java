...
public class MyList<T> {
    ...
    public MyNode<T> getPosition(T t){
        MyNode<T> temp = getFirst();
        while ((temp != null) && (temp.getInfo() != t))
            temp = temp.getNext();

        return temp;
    }
    public MyNode<T> insert(MyNode<T> pos, T t){
    ...
    public MyNode<T> remove(MyNode<T> pos){
        ...
        MyNode<T> nextNode = pos.getNext(); // retrieve nex node to pos.
